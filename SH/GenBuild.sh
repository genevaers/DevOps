...
main() {
echo "Start generation of scripts and JCL";
...
exitIfError;
echo "Performance Engine copy script generated";
...
# Make ascii copies of the tables
  ...
  exitIfError;
  echo "Performance Engine Extensions copy script generated";
...
exitIfError;
echo "Performance Engine build JCL generated";
...
if  [ "$INCLUDE_PEX" == "Y" ]; then 
  ...
  exitIfError;
  echo "Performance Engine Extensions build JCL generated";
  cd ../JCL;
